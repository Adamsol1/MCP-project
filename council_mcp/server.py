...
def _build_participant_variants() -> list[dict]:
    ...
    for cli in all_clis:
        ...
        properties: dict[str, dict] = {
            ...
            "display_name": {
                "type": "string",
                "description": "Optional user-facing participant name shown instead of the raw model identifier",
            },
            "persona_prompt": {
                "type": "string",
                "description": "Optional participant-specific persona instruction prepended before the shared deliberation prompt",
            },
        }
