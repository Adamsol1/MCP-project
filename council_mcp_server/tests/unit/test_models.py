...
class TestParticipant:
    ...
    def test_participant_accepts_display_name_and_persona_prompt(self):
        """Participants can carry app-facing names and persona text."""
        p = Participant(
            cli="claude",
            model="claude-3-5-sonnet-20241022",
            display_name="Norway Analyst",
            persona_prompt="You are a Norwegian telecom resilience analyst.",
        )
        assert p.display_name == "Norway Analyst"
        assert p.persona_prompt == "You are a Norwegian telecom resilience analyst."
